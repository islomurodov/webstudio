...
const items = ref<{ img: string, name: string, position: string }[]>([{ img: 'person-1.jpg', name: 'Игорь Демьяненко', position: 'Product Designer' }, { img: 'person-2.jpg', name: 'Ольга Репина', position: 'Frontend Developer' }, { img: 'person-3.jpg', name: 'Николай Тарасов', position: 'Marketing' }, { img: 'person-4.jpg', name: 'Михаил Ермаков', position: 'UI Designer' }])
</script>

<template>
  <div class="bg-[#F5F4FA]" w-full flex items-center justify-center py-20>
            ...
            <div v-for="(item, i) in items" :key="i" overflow-hidden rounded bg-white shadow>
              ...
              <div py-5 md:py-10>
                <div text-center>
                  ...
                  <span text-primary-gray>{{ item.position }}</span>
                </div>
                <div my-5 />
                  ...
                  <ul flex items-center gap-4>
                    <LinkButton>
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_1_3563)">
                          ...
                          <path d="M16.5777 4.6611C16.5777 5.32346 16.0407 5.86052 15.3781 5.86052C14.7158 5.86052 14.1787 5.32346 14.1787 4.6611C14.1787 3.99858 14.7158 3.46167 15.3781 3.46167C16.0407 3.46167 16.5777 3.99858 16.5777 4.6611Z" fill="#AFB1B8" />
                        </g>
                        <defs>
                    ...
                    <LinkButton>
                      <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20 2.79875C19.2563 3.125 18.4637 3.34125 17.6375 3.44625C18.4875 2.93875 19.1363 2.14125 19.4412 1.18C18.6488 1.6525 17.7738 1.98625 16.8412 2.1725C16.0887 1.37125 15.0162 0.875 13.8462 0.875C11.5763 0.875 9.74875 2.7175 9.74875 4.97625C9.74875 5.30125 9.77625 5.61375 9.84375 5.91125C6.435 5.745 3.41875 4.11125 1.3925 1.6225C1.03875 2.23625 0.83125 2.93875 0.83125 3.695C0.83125 5.115 1.5625 6.37375 2.6525 7.1025C1.99375 7.09 1.3475 6.89875 0.8 6.5975C0.8 6.61 0.8 6.62625 0.8 6.6425C0.8 8.635 2.22125 10.29 4.085 10.6712C3.75125 10.7625 3.3875 10.8062 3.01 10.8062C2.7475 10.8062 2.4825 10.7913 2.23375 10.7362C2.765 12.36 4.2725 13.5538 6.065 13.5925C4.67 14.6838 2.89875 15.3412 0.98125 15.3412C0.645 15.3412 0.3225 15.3263 0 15.285C1.81625 16.4563 3.96875 17.125 6.29 17.125C13.835 17.125 17.96 10.875 17.96 5.4575C17.96 5.27625 17.9538 5.10125 17.945 4.9275C18.7588 4.35 19.4425 3.62875 20 2.79875Z" fill="#AFB1B8" />
                      </svg>
                    </LinkButton>
                    <LinkButton>
                      <svg width="11" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8.33076 3.32083H10.1566V0.140833C9.8416 0.0975 8.75826 0 7.4966 0C4.8641 0 3.06076 1.65583 3.06076 4.69917V7.5H0.155762V11.055H3.06076V20H6.62243V11.0558H9.40993L9.85243 7.50083H6.6216V5.05167C6.62243 4.02417 6.8991 3.32083 8.33076 3.32083Z" fill="#AFB1B8" />
                      </svg>
                    </LinkButton>
                    <LinkButton>
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
