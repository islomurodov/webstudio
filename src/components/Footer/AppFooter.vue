...
<template>
  <div w-full text-white class="bg-[#2F303A]">
    <div mx-auto max-w-7xl w-full px-4 py-10>
      <div mx-auto w-full flex items-center justify-center container>
        <div w-full flex flex-col items-center justify-between gap-12 lg:flex-row sm:gap-15>
          <div h-full w-full flex flex-col items-center gap-12 md:flex-row lg:gap-15>
            <div w-full flex flex-col items-center gap-4 text-center lg:items-start lg:text-left>
              <div>
                <h1 text-2xl text-white font-bold>
                  <span text-primary-blue font-raleway>Web</span>Studio
                </h1>
              </div>
              <div flex flex-col gap-2>
                ...
                <ul flex flex-col gap-2>
                  <li>
                    <a opacity-60 href="mailto:info@example.com">info@example.com</a>
                  </li>
                  <li>
                    <a opacity-60 href="tel:+380991111111">+38 099 111 11 11</a>
                  </li>
                </ul>
              </div>
            </div>
            <div w-full flex flex-col items-center gap-4 text-center lg:items-start md:text-left>
              <div>
          ...
          <div h-full w-full flex flex-col items-center justify-center gap-4 md:ml-auto lg:items-start>
            ...
            <div w-full>
              <form w-full flex flex-col items-center gap-4 lg:flex-row>
                <input type="email" placeholder="E-mail" w-full border border-white border-opacity-30 rounded bg-transparent px-4 py-2 outline-none>
                <button btn type="submit">
                  Подписаться <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
